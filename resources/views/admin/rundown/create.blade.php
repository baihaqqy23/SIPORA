...
@section('title', 'Tambah Agenda Rundown')
...
<div class="max-w-3xl">
    <div class="mb-6">
        <h1 class="text-2xl font-bold tracking-tight text-neutral-900">Tambah Agenda Rundown</h1>
        <p class="text-sm text-neutral-500 mt-1">Buat jadwal kegiatan non-tanding seperti upacara pembukaan, penutupan, atau briefing.</p>
    </div>

    <form action="{{ route('admin.acara-rundown.store') }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="p-6 bg-white border border-neutral-200/80 rounded-xl shadow-xs space-y-5">
            ...
            <div>
                ...
                <input type="text" id="judul" name="judul" required placeholder="Contoh: Upacara Pembukaan & Parade Kontingen"
                       value="{{ old('judul') }}"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" id="lokasi" name="lokasi" placeholder="Contoh: Stadion Utama / Hall A"
                           value="{{ old('lokasi') }}"
                ...
                <div>
                    ...
                    <input type="text" id="penanggung_jawab" name="penanggung_jawab" placeholder="Contoh: Sie Acara / Bpk. Rudi"
            ...
            <div>
                ...
                <textarea id="catatan" name="catatan" rows="3" placeholder="Informasi detail mengenai agenda, instruksi pakaian, atau perlengkapan..."
                          class="w-full text-sm border-neutral-200 rounded-lg focus:border-blue-500 focus:ring-blue-500 @error('catatan') border-red-500 @enderror">{{ old('catatan') }}</textarea>
                @error('catatan')
                    <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="pt-3 border-t border-neutral-100 flex items-center justify-between">
                ...
                <label class="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" name="dipublikasikan" value="1" {{ old('dipublikasikan', true) ? 'checked' : '' }} class="sr-only peer">
